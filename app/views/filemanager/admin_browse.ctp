<div class="filemanager folder">
	...
	<div class="actions">
		<ul>
			...
			<li><?php echo $this->Filemanager->link(__('Nieuwe klant-map', true), array('controller' => 'filemanager', 'action' => 'create_directory'), $path); ?></li>
			<li><?php echo $this->Filemanager->link(__('Nieuw bestand', true), array('controller' => 'filemanager', 'action' => 'create_file'), $path); ?></li>
		</ul>
	</div>
